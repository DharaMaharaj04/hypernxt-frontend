...
const campuses = [
  ...
  },
  {
    ...
    points: [
      "Tier IV build",
      "Cable Landing Station adjacency",
      "Green power PPAs",
    ],
  },
  {
...
const customers = [
  {
    ...
    copy: "Low-latency trading, sovereign compliance, PCI-ready.",
  },
  {
    name: "AI / Life Sciences",
    copy: "Petascale training, DGX-class nodes, warm-water loops.",
  },
  {
    name: "Media & Gaming",
    copy: "Edge rendering, CDN peering, burstable compute.",
  },
  {
    name: "Public Sector",
    copy: "Regional data residency and high-assurance controls.",
  },
];

const news = [
  {
    title: "Hypernext announces 192MW multi-phase build",
    date: "Aug 2025",
    link: "#",
  },
  {
    title: "Hybrid direct-to-chip cooling patent granted",
    date: "Jun 2025",
    link: "#",
  },
  {
    title: "600MW captive solar plant (Khavda) announced",
    date: "May 2025",
    link: "#",
  },
];
...
const contactInfo = {
  address:
    "13rd Floor, Building 9, Raheja Mindspace Madhapur IT Park, Hyderabad - 500081",
  phone: "+91 9878423333",
...
function SmokeTests() {
  React.useEffect(() => {
    try {
      ...
      console.assert(
        products.some((p) => /HyperOne/.test(p.title)),
        "HyperOne product present",
      );
      console.assert(
        campuses.length === 3,
        "Three campuses expected (Hyderabad + Vizag Campus 1 + Vizag Campus 2)",
      );
      console.assert(
        campuses[0].mw === "110 MW" && campuses[1].mw === "250 MW",
        "MW figures correct",
      );
    ...
    <header className="sticky top-0 z-50 border-b bg-white/90 backdrop-blur">
      <div className="mx-auto max-w-7xl px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Button onClick={() => setPortalOpen(true)}>Launch Portal</Button>
        </div>
        ...
        <motion.div {...fade} className="lg:col-span-7">
          ...
          >
            <Sparkles
              ...
              style={{ color: BRAND.primary }}
            />{" "}
            Responsible, Tier IV, 100% renewable
          </div>
          <h1
          ...
          >
            Hypernext operates Tier IV, fault-tolerant campuses powered by{" "}
            <strong style={{ color: BRAND.primary }}>
              100% renewable energy
            </strong>
            —designed for dense GPU workloads and strict compliance.
          </p>
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            <Button asChild>
              <a
                href="#why"
                aria-label="Explore the Hypernext platform"
            ...
            <Button asChild variant="secondary">
              <a href="#campuses" aria-label="See Hypernext campuses">
                See our campuses
              </a>
            </Button>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span style={{ color: BRAND.text }}>
                ISO 27001/22301/14001 • SOC 2 (ready)
              </span>
            </div>
          </div>
          ...
          {/* Slim KPI strip */}
          <div
            className="mt-10 grid grid-cols-2 sm:grid-cols-5 gap-0 border-t border-b"
    ...
    <section id="why" className="py-20 bg-white">
      <div className="mx-auto max-w-7xl px-6">
        <motion.div {...fade} className="max-w-2xl">
          <h2 className="text-4xl font-bold" style={{ color: BRAND.text }}>
            Why Hypernext
          </h2>
          <p className="mt-3" style={{ color: BRAND.muted }}>
            Reliability, density, and clean power without clutter. We build for
    ...
    <section id="hyperone" className="py-20 bg-white">
      <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-10 items-start">
        <motion.div {...fade}>
          ...
          <p className="mt-3" style={{ color: BRAND.muted }}>
            Single control plane for power, cooling, network, compute, and
            security. Policy, observability, open APIs.
          </p>
          <ul
          ...
          <div className="mt-6 flex gap-3">
            <Button asChild>
              <a href="#contact" aria-label="Request a HyperOne OS demo">
                Request a demo
              </a>
            </Button>
        ...
        <motion.div {...fade}>
          ...
          >
            <div
              ...
              style={{ color: "rgba(1, 11, 5, 0.94)" }}
            >
              Control surfaces
            </div>

            <div className="mt-3 grid grid-cols-2 gap-3">
              {["Status", "Approvals", "Cooling", "Provisioning"].map(
                (k, i) => (
                  <div
                    key={k}
      ...
      <div className="mx-auto max-w-7xl px-6">
        <motion.div {...fade} className="flex items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-3" style={{ color: BRAND.muted }}>
              CLS proximity, carrier-rich, renewable corridors—sub-5ms at scale.
            </p>
          </div>
          <Button asChild>
            ...
            <Card key={c.city}>
              ...
              <CardContent className="text-sm" style={{ color: BRAND.muted }}>
                <div
                  ...
                  style={{ color: BRAND.text }}
                >
                  <Zap className="h-4 w-4" style={{ color: BRAND.primary }} />{" "}
                  {c.mw}
                </div>
    ...
    >
      <div className="mx-auto max-w-7xl px-6">
        <motion.div {...fade} className="max-w-3xl">
          ...
          <p className="mt-3" style={{ color: BRAND.muted }}>
            Our campuses are powered by{" "}
            <strong style={{ color: BRAND.primary }}>
              100% renewable energy
            </strong>{" "}
            including a 600 MW captive solar plant (Khavda). We practice hourly
            REC matching, water stewardship, and continuous efficiency
            improvements.
          </p>
        </motion.div>
        ...
        <div className="mt-8 grid sm:grid-cols-3 gap-6">
          {[
            {
              icon: Leaf,
              h: "100% Renewable Energy",
              p: "24/7 clean supply via PPAs + firming; hourly REC matching.",
            },
            {
              icon: Zap,
              h: "High Efficiency",
              p: "PUE ≤ 1.15 design, hot/cold aisle + liquid-ready bays.",
            },
            {
              icon: Droplet,
              h: "Water Stewardship",
              p: "Adiabatic-free modes, reuse & monitoring for lower WUE.",
            },
          ].map((b) => (
...
function Customers() {
  return (
    <section id="customers" className="py-20 bg-white">
      <div className="mx-auto max-w-7xl px-6">
        <h2 className="text-4xl font-bold" style={{ color: BRAND.text }}>
          Built for regulated & performance-critical workloads
        </h2>
    ...
    <section id="news" className="py-20" style={{ background: BRAND.bgLight }}>
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex items-end justify-between">
          ...
          <button className="text-sm" style={{ color: BRAND.primary }}>
            View all
          </button>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-3" style={{ color: BRAND.muted }}>
              Electrical, mechanical, networks, software, security,
              operations—world-class team pushing sustainable AI infrastructure.
            </p>
            <div className="mt-6 flex gap-3">
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-10">
        <div>
          <h2 className="text-4xl font-bold" style={{ color: BRAND.text }}>
            Let's build your footprint
          </h2>
          <p className="mt-3" style={{ color: BRAND.muted }}>
            Tell us about density targets, latency needs, and sovereignty
            requirements. Our architects will propose a reference design and
            power roadmap.
          </p>
          <div className="mt-6 space-y-3 text-sm" style={{ color: BRAND.text }}>
            <div className="flex items-center gap-2">
              <MapPin className="h-4 w-4" style={{ color: BRAND.primary }} />{" "}
              Hyderabad • Vizag (Visakhapatnam)
            </div>
            <div className="flex items-center gap-2">
              <Phone className="h-4 w-4" style={{ color: BRAND.primary }} /> +91
              9878423333
            </div>
            <div className="flex items-center gap-2">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Request a design session</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              {[
                ...
                <div key={f.name} className="col-span-1">
                  ...
                  <input
                    ...
                    style={{ color: BRAND.text, borderColor: BRAND.line }}
                  />
                </div>
              ))}
              <div className="sm:col-span-2">
                <label className="block text-xs" style={{ color: BRAND.muted }}>
                  Density & timeline
                </label>
                <textarea
                  className="w-full rounded-md bg-white border px-3 py-2 text-sm h-24"
                  style={{ color: BRAND.text, borderColor: BRAND.line }}
                  placeholder="e.g., 40MW in 12 months; 70kW/rack; liquid ready"
                />
              </div>
              <div className="sm:col-span-2">
  ...
  return (
    <footer className="border-t bg-white">
      <div className="mx-auto max-w-7xl px-6 py-10 grid md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="mt-3 text-sm" style={{ color: BRAND.muted }}>
            Building world-class, sustainable, AI-ready data centers across
            India.
          </p>
        </div>
        {[
          ...
          {
            h: "Products",
            l: ["Colocation", "GPUaaS", "Energy & Edge", "HyperOne OS"],
          },
          ...
          <div key={g.h}>
            ...
            <ul className="space-y-2 text-sm">
              {g.l.map((x) => (
                <li key={x}>
                  <button className="text-slate-600 hover:text-slate-900 text-left">
                    {x}
                  </button>
                </li>
              ))}
      ...
      <div className="px-6 py-6 text-center text-xs text-slate-500">
        {"\u00A9 "}
        {new Date().getFullYear()} Hypernext Data Center Limited. All rights
        reserved.
      </div>
    </footer>
  );
